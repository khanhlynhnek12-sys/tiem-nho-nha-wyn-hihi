        ...
        <AnimatePresence mode="wait">
          {!selectedChar && !isSpinning && (
            ...
            >
              ...
              <div className="relative w-44 h-44 bg-gradient-to-br from-pink-50/70 to-sky-50/70 dark:from-stone-900 dark:to-stone-800 border-2 border-pink-200 rounded-3xl flex items-center justify-center shadow-xl mb-8 group overflow-hidden">
                <motion.div
              ...
              <button
                onClick={handleSpin}
                className="px-8 py-3.5 bg-pink-400 hover:bg-pink-500 text-white font-bold rounded-2xl shadow-md hover:shadow-lg transition cursor-pointer flex items-center gap-2"
                id="btn-spin-gacha"
              >
          ...
          {isSpinning && (
            ...
            >
              {/* Shaking animation */}
              <motion.div
                className="w-44 h-44 bg-gradient-to-br from-pink-400 to-sky-450 border-2 border-pink-300 rounded-3xl flex items-center justify-center shadow-2xl mb-8 relative"
                animate={{
              ...
              <div className="text-center">
                <p className="text-pink-500 font-semibold flex items-center gap-2 text-sm justify-center">
          ...
          {selectedChar && !isSpinning && (
            <motion.div
              ...
              exit={{ opacity: 0, scale: 0.8 }}
              className="w-full max-w-md bg-white dark:bg-stone-900 border border-pink-100 dark:border-stone-850 rounded-3xl p-6 shadow-2xl relative overflow-hidden"
            >
              {/* Confetti & Burst decor */}
              <div className="absolute top-0 inset-x-0 h-2 bg-gradient-to-r from-pink-400 via-white to-sky-400" />
              <div className="absolute top-3 right-3">
                <span className="px-2.5 py-1 bg-pink-50 dark:bg-stone-950 text-pink-500 dark:text-pink-300 border border-pink-100 text-[10px] font-bold rounded-full uppercase tracking-wider flex items-center gap-1 shadow-xs">
                  <Sparkles className="w-3 h-3 text-pink-400 fill-pink-300" />
                  Nhân duyên!
                </span>
              </div>
              ...
              <div className="flex flex-col items-center text-center mt-3">
                ...
                {/* Opening message */}
                <div className="w-full text-left bg-pink-50/20 dark:bg-pink-950/10 p-4 rounded-2xl border border-pink-100/40 mb-5">
                  <h4 className="text-xs font-bold uppercase tracking-wider text-pink-500 mb-1 flex items-center gap-1">
                ...
                <div className="flex gap-2.5 w-full">
                  <button
                    ...
                    className="flex-1 py-3 px-4 bg-pink-50 dark:bg-pink-950/30 hover:bg-pink-100 dark:hover:bg-pink-950/50 text-pink-600 dark:text-pink-400 font-bold rounded-2xl transition cursor-pointer border border-pink-100/50 dark:border-pink-900/50 flex items-center justify-center gap-2 text-sm"
                  >
